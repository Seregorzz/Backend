...
app.use(session({
    ...
    store: mongoStore.create({mongoUrl:'mongodb+srv://ericksere:coderhouse@cluster0.udncyir.mongodb.net/?retryWrites=true&w=majority', mongoOptions:{useNewUrlParser:true, useUnifiedTopology: true}})
